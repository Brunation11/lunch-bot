...
module.exports = (robot) ->
  robot.respond /(?:youtube|yt)(?: me)? (.*)/i, (msg) ->
    unless process.env.DABOT_YOUTUBE_API_KEY
      return msg.send "You must configure the DABOT_YOUTUBE_API_KEY environment variable"
    query = msg.match[1]
    ...
    robot.http("https://www.googleapis.com/youtube/v3/search")
      .query({
        ...
        q: query
        key: process.env.DABOT_YOUTUBE_API_KEY
      })
      .get() (err, res, body) ->
